...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOnlineRPGGameInstance_Statics::ClassParams = {
		...
		DependentSingletons,
		FuncInfo,
		Z_Construct_UClass_UOnlineRPGGameInstance_Statics::PropPointers,
		nullptr,
		UE_ARRAY_COUNT(DependentSingletons),
		UE_ARRAY_COUNT(FuncInfo),
		UE_ARRAY_COUNT(Z_Construct_UClass_UOnlineRPGGameInstance_Statics::PropPointers),
		0,
		0x009000A8u,
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOnlineRPGGameInstance_Statics::PropPointers) < 2048);
