...
inline ::PROTOBUF_NAMESPACE_ID::uint64 PlayerInfo::_internal_object_id() const {
  return object_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 PlayerInfo::object_id() const {
  // @@protoc_insertion_point(field_get:Protocol.PlayerInfo.object_id)
  return _internal_object_id();
}
inline void PlayerInfo::_internal_set_object_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  object_id_ = value;
}
inline void PlayerInfo::set_object_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
