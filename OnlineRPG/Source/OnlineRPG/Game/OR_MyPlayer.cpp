...
void AOR_MyPlayer::Tick(float DeltaTime)
{
...
void AOR_MyPlayer::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AOR_MyPlayer::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
