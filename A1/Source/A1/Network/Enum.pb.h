...
enum WeaponType : int {
  WEAPON_TYPE_NONE = 0,
  WEAPON_TYPE_SWORD = 1,
  WEAPON_TYPE_AXE_AND_SHILD = 2,
  WEAPON_TYPE_DAGGER = 3,
...
enum MonsterType : int {
  MONSTER_TYPE_NONE = 0,
  MONSTER_TYPE_ELECTRO_SLIME = 1,
  MONSTER_TYPE_WATER_SLIME = 2,
  MONSTER_TYPE_DUCK = 3,
...
constexpr MonsterType MonsterType_MAX = MONSTER_TYPE_DUCK;
...
constexpr MoveState MoveState_MAX = MOVE_STATE_CHARGE;
