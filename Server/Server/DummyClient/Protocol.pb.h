...
class C_SPAWN final :
 ...
 public:
  ...
  inline C_SPAWN* New() const final {
    return new C_SPAWN();
  }

  C_SPAWN* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline ::Protocol::PlayerInfo* C_SPAWN::mutable_players(int index) {
...
inline const ::Protocol::PlayerInfo& C_SPAWN::_internal_players(int index) const {
  return players_.Get(index);
}
inline const ::Protocol::PlayerInfo& C_SPAWN::players(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.C_SPAWN.players)
  return _internal_players(index);
}
inline ::Protocol::PlayerInfo* C_SPAWN::_internal_add_players() {
  return players_.Add();
}
inline ::Protocol::PlayerInfo* C_SPAWN::add_players() {
