...
// uint64 playerIndex = 1;
inline void C_LOGOUT::clear_playerindex() {
  playerindex_ = uint64_t{0u};
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 C_LOGOUT::_internal_playerindex() const {
  return playerindex_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 C_LOGOUT::playerindex() const {
  // @@protoc_insertion_point(field_get:Protocol.C_LOGOUT.playerIndex)
  return _internal_playerindex();
}
inline void C_LOGOUT::_internal_set_playerindex(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  playerindex_ = value;
}
inline void C_LOGOUT::set_playerindex(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_playerindex(value);
  // @@protoc_insertion_point(field_set:Protocol.C_LOGOUT.playerIndex)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 S_LOGOUT::_internal_playerindex() const {
  return playerindex_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 S_LOGOUT::playerindex() const {
  // @@protoc_insertion_point(field_get:Protocol.S_LOGOUT.playerIndex)
  return _internal_playerindex();
}
inline void S_LOGOUT::_internal_set_playerindex(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  playerindex_ = value;
}
inline void S_LOGOUT::set_playerindex(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_playerindex(value);
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 S_LEAVE_GAME::_internal_object_id() const {
  return object_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 S_LEAVE_GAME::object_id() const {
  // @@protoc_insertion_point(field_get:Protocol.S_LEAVE_GAME.object_id)
  return _internal_object_id();
}
inline void S_LEAVE_GAME::_internal_set_object_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  object_id_ = value;
}
inline void S_LEAVE_GAME::set_object_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
