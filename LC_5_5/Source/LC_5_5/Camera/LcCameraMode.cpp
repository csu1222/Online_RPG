...
{
	// 우리가 앞서 ULcCameraMode를 생성하는 곳은 ULcCameraModeStack이었다:
	// - 해당 코드를 보면, GetOuter()를 LcCameraMode로 LcCameraComponent로 설정하였다
	// - ULcCameraModeStack::GetCameraModeInstance() 확인
