...
#include "Lc_5_5/LcGameplayTags.h"
#include "Lc_5_5/LcLogChannels.h"
...
ULcPawnExtensionComponent::ULcPawnExtensionComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
bool ULcPawnExtensionComponent::CanChangeInitState(UGameFrameworkComponentManager* Manager, FGameplayTag CurrentState, FGameplayTag DesiredState) const
{
	check(Manager);
